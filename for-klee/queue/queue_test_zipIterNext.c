...
int main()
{
    ...
    symb_str(a); symb_str(b); symb_str(c); symb_str(d);
    symb_str(e); symb_str(f); symb_str(g);
    ...
    while (queue_zip_iter_next(&zip, &e1, &e2) != CC_ITER_END) {
        if (i == 0) {
            klee_assert(strcmp(str_d, (char*)e1) == 0);
            klee_assert(strcmp(str_g, (char*)e2) == 0);
        }
        if (i == 2) {
            klee_assert(strcmp(str_b, (char*)e1) == 0);
            klee_assert(strcmp(str_e, (char*)e2) == 0);
        }
        i++;
    }
    klee_assert(3 == i);
